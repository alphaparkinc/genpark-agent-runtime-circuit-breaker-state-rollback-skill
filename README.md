# genpark-agent-runtime-circuit-breaker-state-rollback-skill
...
> **GenPark AI Agent Skill** -- Autonomous LLM agent failure circuit-breaker & state rollback orchestrator
